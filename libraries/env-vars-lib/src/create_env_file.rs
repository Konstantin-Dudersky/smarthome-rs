...
//! Используется TOML. Пакет envy умеет только десериализовывать, TOML
//! наиболее близкий. Вручную переводим в UPPER_CASE, у envy проблемы, если
//! использовать атрибуты из serde
...
/// Итерируемся по строкам и в каждой строке переводим название переменной
/// в UPPER_CASE
